...
The code chunk below loads and clean the data for regression analysis. We will convert numeric variables into factor variables for categorical variables `babysex`, `frace`, `malform`, and `mrace`. We will also assign subject IDs to each observation in our dataset.
